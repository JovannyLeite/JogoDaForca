...
def rand_word():
    with open ('palavras.txt', 'rt') as f:
        bank = f.readlines()
    return bank[random.randit(0, len(bank))].strip()

#Função Main - Execução do Programa
def main():
    #Objeto
    game = Hagman(rand_word())

    #Enquanto o jogo não tiver terminado, imprime o status, solicita uma letra e faz a leitura do caracter
